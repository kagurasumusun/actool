...
Remaining (matched renditions 9/16 vs reference; the CAR loads):
- **Per-(idiom,subtype) MultiSized renditions**, each MSIS entry tagged with idiom. We still emit a single combined multisize (incl. marketing's 1024). Reference splits: phone `{20:1,29:2,40:3,60:4}`, phone/**subtype 1792** `{90:7}`, pad `{20:1,29:2,40:3,76:5,83:6}`, marketing `{1024:8}`.
