...
*   [Free download on the App Store](https://apps.apple.com/us/app/markchart-mermaid-editor/id6475648822)

[![MarkChart](https://blog.timac.org/MarkChart.png)](https://apps.apple.com/us/app/markchart-mermaid-editor/id6475648822)
...
However contrary to a _regular_ bom file, a car file contains several bom ‘blocks’:
...
if(blockData != nil)
{
	struct carheader *carHeader = (struct carheader *)
[blockData bytes];
	[...]
}
...
In this tree, the keys are the appearance names (strings) while the values are the appareance unique identifiers (uint16\_t). Parsing the key/value pairs is thus trivial:
...
if(blockData != nil)
{
	struct renditionkeyfmt *keyFormat = (struct renditionkeyfmt *)
[blockData bytes];
...
*   CUIRawDataRendition: pixelFormat is set to ‘DATA’ and layout to kRenditionLayoutType\_Data
*   CUIRawPixelRendition: pixelFormat is ‘JPEG’ or ‘HEIF’. The layout is set to an image subtype.
*   CUIThemeColorRendition: pixelFormat is 0 and layout to kRenditionLayoutType\_Color
...
*   Capture screenshots
*   Quick Look integration
*   [Free download on the Mac App Store](https://apps.apple.com/us/app/dotchart-for-dot-and-graphviz/id6737857267)

[![DotChart](https://blog.timac.org/DotChart.png)](https://apps.apple.com/us/app/dotchart-for-dot-and-graphviz/id6737857267)
